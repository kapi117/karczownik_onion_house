...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, KTIR_1_Pin|KTIR_2_Pin|KTIR_3_Pin|KTIR_4_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(COLOR_LEFT_SCL_GPIO_Port, COLOR_LEFT_SCL_Pin);

    HAL_GPIO_DeInit(COLOR_LEFT_SDA_GPIO_Port, COLOR_LEFT_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB3     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(COLOR_RIGHT_SCL_GPIO_Port, COLOR_RIGHT_SCL_Pin);

    HAL_GPIO_DeInit(COLOR_RIGHT_SDA_GPIO_Port, COLOR_RIGHT_SDA_Pin);
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = ENCODER_LEFT_1_Pin|ENCODER_LEFT_2_Pin;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, ENCODER_LEFT_1_Pin|ENCODER_LEFT_2_Pin);
